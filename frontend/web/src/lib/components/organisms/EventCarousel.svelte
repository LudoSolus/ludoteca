...
<style>
  ...
  .event-carousel-body {
    ...
    display: flex;
    gap: 1rem;
    /* overflow-x sem scroll-behavior: smooth para não conflitar com rAF */
    overflow-x: auto;
    padding-bottom: 0.5rem;
    /* scroll-snap desativado durante animação manual — reativado via classe */
    scroll-snap-type: none;
  }

  .event-carousel-body::-webkit-scrollbar { display: none; }
  .event-carousel-body { -ms-overflow-style: none; scrollbar-width: none; }
  ...
  @media (max-width: 639px) {
    .nav-wrapper { flex: 0 0 36px; width: 36px; }
