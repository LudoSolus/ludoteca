...
<main class="flex w-full flex-col items-center justify-start gap-5 px-4 py-12 sm:px-10 xl:px-15">
	<div class="flex w-full justify-end">
		<Button text="Criar" leftIcon={faPlus} onClick={() => goto('/admin/board-games/create')} />
	</div>
	<div
		class="section-height flex w-full max-w-350 items-start justify-center gap-20 lg:justify-between"
	>
