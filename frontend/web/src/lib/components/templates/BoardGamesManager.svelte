...
<main
	class="flex h-full items-start justify-center lg:justify-between gap-20 overflow-y-auto px-1 py-7 sm:px-10 xl:px-15"
>
	<section class="flex max-w-200 flex-1 flex-col items-center justify-center pt-0 lg:pt-20 gap-8">
		...
		<div class="flex flex-col gap-8">
			<div class="flex w-full max-w-150 items-center justify-start gap-5">
